...
gps_data = pd.read_csv('Data/CustomData/0704140126-21241.csv')
columns = ['X', 'Y', 'time']
...
print gps_values.head()

gps_values.to_csv('Data/gps_data.csv')


gps_data = pd.read_csv('Data/CustomData/0704130013-20019.csv')
columns = ['X', 'Y']
gps_data = gps_data.filter(items=columns)
